...
export default function DisplayCharSheet({ currentChar, setCurrentChar, index }) {
  ...
  return (
    <Box>
      ...
      <Box sx={{
        display: 'flex', flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', border: 'solid',
      }}
      >
        <Box sx={{
          display: 'flex', flexDirection: 'column', border: 'solid',
        }}
        >
          <h1>charInfo</h1>
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', border: 'solid' }}>
          <h1>Attacks</h1>
          <h4>
